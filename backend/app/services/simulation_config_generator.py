...
**정당 간 관계 규칙 (절대 위반하지 마세요)**:
- 같은 정당 소속은 서로 공격하지 않습니다 (민주당↔민주당 우호, 국힘↔국힘 우호)
- 민주당 측 Agent가 민주당 후보를 비판하는 게시글을 만들지 마세요
- 국민의힘 측 Agent가 국민의힘 후보를 비판하는 게시글을 만들지 마세요
- 비판은 반드시 상대 진영을 향해야 합니다
